...
public abstract class DoubleBuffering2 extends Canvas {
	/** Public constant, just so clients will know what to expect when they create a default BufferedCanvas. */
	public static final int DEFAULT_REFRESH_RATE = 30;

    /** ATTENTION SUBCLASS IMPLEMENTORS: Here's the only abstract method.  Subclasses can simply render to this graphics context, and not worry about all the other details.  This is part of the power of OO design. */
            ...
            try {
                while (!killed) {
                    if (!paused) {
                    	...
                    	DoubleBuffering2.this.repaint();
                    }
                    sleep(DoubleBuffering2.this.refresh_rate);
                }
